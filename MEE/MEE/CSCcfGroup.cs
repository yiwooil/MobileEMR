...
namespace MEE
{
    class CSCcfGroup
    {
        ...
        public List<CDCcfGroup> m_CcfGroupList;
        ...
        public Boolean getData()
        {
            try
            {
                ...
                m_CcfGroupList = null;
                m_CcfGroupList = new List<CDCcfGroup>();
                ...
                else
                {
                    ...
                    for (int i = 0; i < cnt; i++)
                    {
                        ...
                        CDCcfGroup ccfGroup = new CDCcfGroup();
                        ccfGroup.ccfGroup = (string)dtRow["ccf_group"].GetValue();

                        m_CcfGroupList.Add(ccfGroup);
                    }
                    return true;
                }
            }
